...
// ANSWER: The amount of RAM is determined by the input size of the array, giving it a space complexity of O(n).
...
// Q: Given an array of numbers, what is the space complexity of this function?
// ANSWER: This has a space complexity of O(n), because of the input size of the array
...
// ANSWER: The length of the for loop is set, it will only run 5 times, because of this, it has a space complexity of O(1).
...
// Q: What is the space complexity of the function?
// ANSWER: This is a nested for loop which gives it quadratic shape. This gives it a space complexity of O(n*n)
...
// ANSWER: This would be linear because the space complexity of the filter function is determined by the size of numbers. 
...
// ANSWER: This would be linear because the space complexity of the map function is determined by the size of numbers. 
...
// Q: What is the space complexity of this function?
// ANSWER: This loop has a space complexity of O(n) as it is dependent on the length of the numbers array.


// Q: Is it possible to improve this function's space complexity? If it is, write a new function below.
// ANSWER: We can marginally change it's speed. However the time complexity of O(n) can't be improved on.
...
// ANSWER: These have identical space complexity. 
...
// ANSWER: Both of these function's space complexity are dependent on the length of the string. 
...
const myFac = Factorial()

console.time("not memoized factorial");
console.log(myFac.noCacheCalcFac(8))
console.log(myFac.noCacheCalcFac(8))
console.log(myFac.noCacheCalcFac(8))
console.log(myFac.noCacheCalcFac(8))
...
// ANSWER: The one using the cache and memoization will be faster

// Now fill this out and run your file

// CREATE A NEW INSTANCE OF YOUR CLASS
let myCube = new Cubed()

console.time("not memoized function time");
console.log(noncachedCubed(4))
console.log(noncachedCubed(4))
console.log(noncachedCubed(4))
console.log(noncachedCubed(4))
...
console.log(myCube.cachedCubed(4))
console.log(myCube.cachedCubed(4))
console.log(myCube.cachedCubed(4))
console.log(myCube.cachedCubed(4))
